...
public class StreamStorageFSOldTest {

    @Test
    public void testCreateNewStreamFileStorage() throws IOException {
        FileUtil.resetDir(new File("data/test-stream-1"));
        StreamStorageFSOld streamStorageFS = new StreamStorageFSOld("test-stream-1", "data/test-stream-1");
    ...
    public void testAppendSplitsIntoMultipleFiles() throws IOException {
        ...
        StreamStorageFSOld streamStorageFS = new StreamStorageFSOld("test-stream-1", "data/test-stream-1", 20);
